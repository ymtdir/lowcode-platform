    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button
          ...
          className="opacity-0 group-hover/item:opacity-100 group-hover/workspace:opacity-100 pointer-events-none group-hover/item:pointer-events-auto group-hover/workspace:pointer-events-auto flex items-center justify-center size-5 shrink-0 rounded hover:bg-primary/10 cursor-pointer transition-opacity outline-none focus:outline-none"
        >
